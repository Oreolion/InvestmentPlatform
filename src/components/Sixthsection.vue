<template>
  <section>
    <div class="leftbox">
      <h4>WHY US</h4>
      <h1>The heart of our strategy is simple</h1>
      <P
        >Trade globally in crypto, options, futures, currencies, bonds, and
        funds from a unified platform. Fund your account in multiple currencies
        and trade assets denominated in multiple currencies—access market data
        24 hours a day and six days a week.</P
      >
      <ul>
        <li>
        ...
        <li>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
              d="M342.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 178.7l-57.4-57.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l80 80c12.5 12.5 32.8 12.5 45.3 0l160-160zm96 128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 402.7 54.6 297.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l256-256z"
            /></svg
          ><span>Encrypted User Database</span>
        </li>
        <li>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
    ...
    <div class="rightbox">
      <div class="box">
        ...
        <h4>Sprint Connectivity</h4>
        <p>
          24/7 access to multiple spot exchanges, OTC derivatives, and our
          superior lending desk.
        </p>
      </div>
      <div class="box">
        ...
        <h4>Optimum Risk</h4>
        <p>
          Access to the best risk transfer pricing in the market via our block
          and electronic OTC desk.
        </p>
      </div>
      <div class="box">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <h4>Diversify Assets</h4>
        <p>
          Tailored digital asset, stablecoin, fiat lending, and structured
          solutions.
        </p>
      </div>
      <div class="box">
        ...
        <h4>Innovation</h4>
        <p>Trust and transparency of a publicly listed company.</p>
      </div>
    </div>
  </section>
</template>
